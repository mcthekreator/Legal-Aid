...
import ray from "../assets/images/e89905c4d9f7108cde6e4982e47baab1.jpg";
      ...
      <main className=" flex flex-col items-center justify-center">
        ...
        <div className="w-full h-auto  flex flex-col flex-grow space-y-6 black items-center mt-28 text-center z-20">
          ...
          <motion.p
            ...
            className="text-blue-600 text-5xl tracking-wide"
          >
            Meet Our Advocates
          </motion.p>
          <motion.hr
          ...
          >
            ...
            tackling the most complex legal challenges with finesse and
            precision.
          </motion.p>
          <motion.div
            initial={{ opacity: 0 }}
        ...
        <div
          ref={ref}
          className="w-full h-auto grid grid-cols-1 2xl:grid-cols-2 xl:grid-cols-2 lg:grid-cols-2 md:grid-cols-1 gap-2  bg-black px-8 mt-14 pb-2 cursor-pointer"
        >
          <Patner
            image={jo}
            to="/patners/jollin"
          ...
          <Patner
            ...
            title="LL.B [Hons] University of Nairobi"
            caption="Dip. Law [KSL]"
          />
        </div>
      </main>
