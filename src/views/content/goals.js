...
function Goals() {
    return (
     <div className='w-full h-auto flex flex-wrap'>
      ...
      <div className='w-full 2xl:w-3/4 xl:w-3/4 lg:w-3/4 md:w-3/4  cursor-pointer text-black flex flex-col items-center text-center p-8 space-y-8 leading-loose tracking-wide '>
      ...
      <Goal image={commit} title="Commitment" desc="At Scottish Legal Aid Board, we strive to be trusted 
