...
class CustomSlider extends Component {
  ...
  render() {
    return (
      <div className="pb-8 bg-white flex flex-col space-y-8 saturate-100 cursor-pointer  items-center justify-center  text-center text-black ">
        <div className="my-4 tracking-wider hover:scale-110">
          <h1>OUR VALUES</h1>
          <div className="border-b border border-blue-800 mt-2"></div>
        </div>
        <Carousel
          infiniteLoop
          showThumbs={false}
