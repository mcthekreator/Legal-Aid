...
function Intro() {
  return (
    <div className="h-screen text-black flex flex-col items-center justify-center -mt-8  z-20  ">
      <motion.h1
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        exit={{ opacity: 0 }}
      ...
      >
        Your{" "}
        <span className="text-blue-800 tracking-wider">Legal Compass </span>
      </motion.h1>
      <motion.h1
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      >
        In A <span className="text-4xl font-bold">Complex World</span>
      </motion.h1>
      <motion.div
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      >
        ...
        <Info
          icon={<MdLocationOn />}
          title="NSSF Building, 11th floor room 1114, United Kingdom"
        />
        <Info
          icon={<MdEmail />}
          title="info@scottishlegalaidboardbuilding,.com"
        />
      </motion.div>
    </div>
  );
