      ...
      <main className="flex flex-col items-center justify-center">
        ...
        <div className="w-full h-auto  flex flex-col flex-grow space-y-4 black items-center mt-24 text-center z-20">
          <motion.p
            ...
            className="text-blue-600 font-bold tracking-wider  text-2xl"
          >
            WHERE TO FIND US
          </motion.p>
          <div className="w-full h-auto  p-8  flex flex-col cursor-pointer items-center justify-center  text-center text-slate ">
            <div className="h-full grid grid-cols-1 2xl:grid-cols-3 xl:grid-cols-3 lg:grid-cols-3 md:grid-cols-2 gap-0 2xl:gap-12 xl:gap-12 lg:gap-12 md:gap-2 ">
              <Address
                border="2xl:border-r xl:border-r lg:border-r"
                size="h-24 w-24"
                contact={contact}
              >
                <motion.div
                ...
                >
                  <p>Phone:+020 729 156 650</p>
                  <p>info@scottishlegalaidboard.com</p>
                </motion.div>
              </Address>
              <Address
                border="2xl:border-r xl:border-r lg:border-r"
              ...
              >
                ...
                >
                  ...
                  <p>United Kingdom</p>
                  <p>Scottish Legal Aid Board Building, 11th floor room 1114</p>
                </motion.div>
              </Address>
            ...
            >
              <BsFillArrowDownCircleFill
                ...
                className="text-3xl text-blue-600 animate-bounce cursor-pointer"
              />
            </motion.div>
          </div>
        </div>
        ...
        <div
          ...
          data-aos="fade-up"
          data-aos-delay="200"
          className="w-full h-auto pt-8 space-y-2 flex flex-col z-40 items-center justify-center text-center bg-slate "
        >
          <img
            src={mail}
            alt="advocate email"
          ...
          <div className="w-24 h-2 border-b border-black "></div>
          <motion.form
            ref={animateref}
            initial={{ opacity: 0 }}
            animate={inView ? { opacity: 1 } : {}}
            ...
            className="w-full px-8 space-y-4 pb-2"
          ...
          >
            ...
            <textarea
              ...
              className="w-full h-52 font-sans p-4 border border-black focus:outline-none"
              placeholder="Write Message..."
            ></textarea>
            <p className="text-red-500">
              <i>{formik.touched.message && formik.errors.message}</i>
            </p>
            <button
              type="submit"
              className=" btn p-4 w-full 2xl:w-1/4 xl:w-1/4 lg:w-1/4 md:1/4 text-white "
            >
              SEND A MESSAGE
            </button>
          </motion.form>
