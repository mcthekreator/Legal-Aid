...
export default function Footer(){
    ...
    return(
      <footer className='w-full h-auto text-sm bg-blue-800 flex flex-col items-center justify-center p-2 cursor-pointer sticky text-white tracking-wide text-xs'>
      ...
      <div className='w-full 2xl:w-1/4 xl:w-1/4 lg:w-1/4 md:w-1/4 leading-loose tracking-wider'>
        <p>ABOUT US</p>
        <p>At Scottish Legal Aid Board, we are not just legal advisors; we are strategic partners invested in your 
      ...
      <Info icon={<BsTelephoneFill />} title='+020 729 156 650'/>
   
       <Info icon={<MdLocationOn />} title='NSSF Building, 11th floor room 1114'/>
       <Info icon={<MdLocationOn />} title='United Kingdom'/>
       <Info icon={<MdEmail />} title='info@scottishlegalaidboard.com'/>
      </div>
      ...
      <p className='text-center'>Copyright ©2023 Scottish Legal Aid Board All Rights Reserved</p>
      </footer>
    )
}
