...
function Goal(props) {
    return (
     <div data-aos-duration='2000' data-aos="fade-right" data-aos-delay="200" className='block 2xl:flex xl:flex lg:flex md:flex space-x-4'>
        <div className='h-36 w-36 p-4 bg-white rounded-full shadow-md shadow-blue-800 hidden 2xl:flex xl:flex lg:flex md:flex items-center justify-center'>
       ...
       <p>{props.title}</p>
        <hr className='w-20 border-b border border-blue-800'/>
        <p>{props.desc}</p>
       </div>
    </div>
    );
